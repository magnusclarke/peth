...
class Tree 
{
	...
	void simSeg(double &a, double &s, double &s2, double &dt, double &lim, int &kernel, int &ratecut, vector<int> &node, vector<vector<double> > &nodeVal, vector<vector<double> > &run_vals, double &cov);
...
public:
	...
	void 	simulation(double &a, double &sigma, double &sigma2, double &dt, double &lim, int &kernel, int &ratecut, double &cov);
